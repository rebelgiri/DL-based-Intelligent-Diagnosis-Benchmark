...
def get_files(root, test=False):
    ...
    '''
    datasetname = os.listdir(root)  # 0:bearingset, 2:gearset
    root1 = os.path.join(root, datasetname[1])  # Path of bearingset
    root2 = os.path.join(root, datasetname[0])  # Path of gearset
    ...
    def data_preprare(self, test=False):
        ...
        if test:
            ...
            train_pd, val_pd = train_test_split_order(
                data_pd, test_size=0.2, num_classes=20)
